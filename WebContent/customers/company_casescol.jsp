...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="ibox-content">
						<div class="table-responsive">
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach items="${requestScope.comcol }" var="col"
										varStatus="status">
										<tr>
											<td>${col.name }</td>
											<td>${col.plot_name }</td>
											...
											<a href="<%=path %>/customer/deletecompany?id=${col.id }"><i class="fa fa-check text-navy">取消收藏</i></a>
										</tr>
									</c:forEach>
								</tbody>
							</table>
		...
		<nav aria-label="...">
			<ul class="pager">
				<li class="previous"><a
					href="<%=path %>/customer/comcasecol?pageNo=${currPage - 1 }"><span
