...
<body>
	<div>
		<c:choose>
			<c:when
				test="${sessionScope.customer != null || sessionScope.company != null || sessionScope.designer != null || sessionScope.supply  != null}">
	...
	<div class="divs">
		...
		<div class="div_si col-lg-6">
			<input type="hidden" id="descase_id"
				value="${requestScope.desdetail.id}"> <span>案例名称：${requestScope.desdetail.name}</span>
			<span>装修风格：${requestScope.desdetail.style}</span>
			<p>简介:${requestScope.desdetail.des}</p>
			<c:if test="${requestScope.saved == false }">
				<a onclick="designercase_col();" id="save" type="button"
	...
	<div class="tab-content container">
		<div role="tabpanel" class="tab-pane active" id="home">
			<img class="center-block"
				src="<%=path %>/${requestScope.desdetail.image_1}" style="width:810px; height:500px;">
		</div>
		<div role="tabpanel" class="tab-pane" id="profile">
			<img class="center-block"
				src="<%=path %>/${requestScope.desdetail.image_2}" style="width:810px; height:500px;">
		</div>
		<div role="tabpanel" class="tab-pane" id="messages">
			<img class="center-block"
				src="<%=path %>/${requestScope.desdetail.image_3}" style="width:810px; height:500px;">
		</div>
		<div role="tabpanel" class="tab-pane" id="settings">
			<img class="center-block"
				src="<%=path %>/${requestScope.desdetail.image_4}" style="width:810px; height:500px;">
		</div>
		<div role="tabpanel" class="tab-pane" id="setting1">
			<img class="center-block"
				src="<%=path %>/${requestScope.desdetail.image_5}" style="width:810px; height:500px;">
		</div>
	</div>
...
<div>
	...
	<script src="<%=path%>/js/customer/designercase_col.js"></script>
</body>
</html>