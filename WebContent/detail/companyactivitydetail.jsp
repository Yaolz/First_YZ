	...
	<div class="divs">
		...
		<div class="div_si col-lg-6">
			<input type="hidden" id="comcase_id"
				value="${requestScope.comact }">
			<p>活动名称：${requestScope.comact.name}</p>
			<p>活动发布时间：${requestScope.comact.created_time}</p>
			<p>简介:${requestScope.comact.des}</p>
		</div>
		<div class="col-lg-3 center-block"></div>
	</div>
	<div class="tab-content container">
		<div ><img src="<%=path %>/${requestScope.comact.image}" class="center-block"></div>
	</div>
	<div>
