                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	 <a href="<%=path %>/comactivity/editor_page?id=${com.id }"><i class="fa fa-check text-navy">修改活动</i></a>
                                           <a href="<%=path %>/comactivity/companyactivity_info?id=${com.id }"><i class="fa fa-check text-navy">查看详情</i></a>
                                            <c:choose>
													<c:when test="${com.status == 'Y' }"><a href="<%=path %>/comcase/com_status?id=${com.id }"><i
													class="fa fa-check text-navy">冻结</i></a></c:when>
													<c:when test="${com.status == 'N' }"><a href="<%=path %>/comcase/com_status?id=${com.id }"><i
													class="fa fa-check text-navy">激活</i></a> </c:when>
													<c:otherwise>其他</c:otherwise>
												</c:choose>
                                        </td>
                                    </tr>
